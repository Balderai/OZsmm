...
export const mockDocuments: PortalDocument[] = [
  {
    ...
    title: "Vergi Levhası",
    description: "Klasör: 01_Firma Resmi Belgeler",
    storageBucket: STORAGE_BUCKET,
    storagePath: "firm_111/client_444/declarations/01-firma-resmi-belgeler/vergi-levhasi.pdf",
  ...
  },
  {
    ...
    folderType: "accruals",
    origin: "accountant_shared",
    title: "Mayıs KDV Tahakkuk Fişi",
    description: "Ay: 05_Mayıs",
    storageBucket: STORAGE_BUCKET,
    storagePath: "firm_111/client_444/accruals/05-mayis/mayis-tahakkuk.pdf",
    mimeType: "application/pdf",
  ...
  },
  {
    ...
    title: "Yakıt Faturası Fotoğraf",
    description: "Ay: 06_Haziran\nEvrak türü: Fatura",
    storageBucket: STORAGE_BUCKET,
    storagePath: "firm_111/client_444/documents_photos/06-haziran/fatura/yakit.jpg",
    mimeType: "image/jpeg",
  ...
  },
  {
    ...
    description: "Ay: 06_Haziran\nEvrak türü: Diğer",
    storageBucket: STORAGE_BUCKET,
    storagePath: "firm_111/client_555/documents_photos/06-haziran/diger/dekont.pdf",
    mimeType: "application/pdf",
...
export const mockNotifications: PortalNotification[] = [
  {
    ...
    body: "Mayıs KDV tahakkuk fişiniz Aylık Tahakkuklar klasörüne eklendi.",
